...
export default function ProductManagement() {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "discount",
      key: "discount",
      render: (text) => (text ? `${text}%` : "0%"), // Hiển thị phần trăm giảm giá
    },
    {
      ...
      render: (_, record) => {
        const discountedPrice = record.discount
          ...
          : record.price; // Nếu không có discount thì giữ nguyên giá
      ...
      render: (text, record) => (
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          <Button
            type="default"
            size="small"
            onClick={() => handleEditImages(record.productId)} // Sửa Ảnh
